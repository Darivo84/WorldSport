        ...
        <div class="section-content">
            ...
            <div class="left-container">
                <div class="form-container">
                    ...
                    <form action="{{route('admin_client_update',  $client->id)}}" method="post" class="admin-form"
                        ...
                        <fieldset class="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-input-full" value="{{$client->name}}">
                            </div>
            ...
            <div class="preview-pane">
                <?php //<img src="{{ $team_member->image ? $team_member->image :  '/images/no-preview-big.jpg'}}" alt="" class="upload-preview"> ?>
